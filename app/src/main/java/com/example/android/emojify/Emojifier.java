    ...
    static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap picture) {
        ...
        if(faces.size() == 0) {
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                // Get the appropriate emoji bitmap for each face
                Bitmap emojiBitmap;
                int emojiDrawableId;
                switch (whichEmoji(face)) {
                    case SMILE:
                        ...
                        break;
                    case FROWN:
                        emojiDrawableId = R.drawable.frown;
                        break;
                    case LEFT_WINK:
                        emojiDrawableId = R.drawable.leftwink;
                        break;
                    case RIGHT_WINK:
                        emojiDrawableId = R.drawable.rightwink;
                        break;
                    case LEFT_WINK_FROWN:
                        emojiDrawableId = R.drawable.leftwinkfrown;
                        break;
                    case RIGHT_WINK_FROWN:
                        emojiDrawableId = R.drawable.rightwinkfrown;
                        break;
                    case CLOSED_EYE_SMILE:
                        emojiDrawableId = R.drawable.closed_smile;
                        break;
